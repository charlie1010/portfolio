...
export const categories: Category[] = [
  {
    ...
    number: "01",
    title: "Structure",
    description: "Shaping complex work into clear choices.",
  ...
  },
  {
    ...
    number: "02",
    title: "Exploration",
    description: "Learning through people and early experiments.",
  ...
  },
  {
    ...
    number: "03",
    title: "Execution",
    description: "Turning ideas into testable, real work.",
  ...
  },
  {
    ...
    number: "04",
    title: "Connection",
    description: "Building trust and shared momentum.",
...
export const projects: Project[] = [
  // Category 1: Structure
  {
    ...
    title: "In-Home Robotics Strategy",
    role: "Innovation Strategist Intern",
    subtitle: "Consumer Tech • Innovation Strategy",
    company: "Samsung",
    category: "Structure",
  ...
  },
  {
    ...
    title: "Health System Growth Strategy",
    role: "Senior Strategy Consultant, Monitor Deloitte",
    subtitle: "Healthcare • Growth Strategy",
  ...
  // Category 2: Exploration
  {
    ...
    title: "Nutrition Through Reflection",
    role: "Co-Founder",
    subtitle: "Digital Health • Product Design",
    company: "Ambrosia",
  ...
  },
  {
    ...
    title: "Pharmacy First Model",
    role: "Strategy and Product Intern, mPharma",
    subtitle: "Healthcare • Product Strategy",
    company: "mPharma",
    category: "Exploration",
    categoryId: "category-2",
    year: "2024",
  ...
  },
  {
    ...
    title: "Ergonomic Fireline Tool",
    role: "Developer and Builder",
    subtitle: "Product Design • Research",
    company: "UC Berkeley",
    category: "Exploration",
    categoryId: "category-2",
    year: "2025",
  ...
  // Category 3: Execution
  {
    ...
    subtitle: "Healthcare • Product Launch",
  ...
  },
  {
    ...
    title: "KariOut Brand Refresh",
    role: "Strategist",
    subtitle: "Consumer • Brand Strategy",
    company: "KariOut",
    category: "Execution",
    categoryId: "category-3",
    year: "2018",
  ...
  },
  {
    ...
    title: "480 Sq Ft Garage Build",
    role: "Designer and Builder",
    subtitle: "Personal • Construction",
    company: "Personal",
    category: "Execution",
    categoryId: "category-3",
    year: "2019",
  ...
  // Category 4: Connection
  {
    ...
    title: "Berkeley SkyDeck Community",
    role: "SkyDeck Operator in Residence and Haas Startup Squad Leader",
    subtitle: "Startups • Community Building",
  ...
  },
  {
    ...
    role: "Co-Founder",
    subtitle: "Food & Hospitality • Experience Design",
    company: "Straws in Pockets",
    category: "Connection",
    categoryId: "category-4",
    year: "Ongoing",
  ...
  },
  {
    ...
    role: "Strategy Consultant, Monitor Deloitte",
    subtitle: "Healthcare • Integration Strategy",
    company: "Carle Health",
    category: "Connection",
    categoryId: "category-4",
    year: "2020",
